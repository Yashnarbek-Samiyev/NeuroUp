    ...
    <section className="bg-[#f8fafc] dark:bg-slate-950 pt-4 pb-12 sm:pt-6 sm:pb-16 border-b border-slate-200 dark:border-slate-800 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          {/* Left Column: Well-proportioned Typography */}
          <div className="lg:col-span-7 space-y-4">
            ...
            {/* Main Heading: Moderate & Elegant Size */}
            ...
            <div className="flex flex-wrap items-center gap-3 pt-1">
              <button
                ...
                className="px-5 py-2.5 rounded-xl bg-brand-600 hover:bg-brand-700 text-white font-bold text-sm flex items-center gap-2 transition-all shadow-sm"
              >
              ...
              <button
                ...
                className="px-5 py-2.5 rounded-xl bg-navy-800 hover:bg-navy-900 text-white font-bold text-sm flex items-center gap-2 transition-all shadow-sm"
              >
            ...
            <div className="grid grid-cols-3 gap-3 pt-1 max-w-xl">
              <div 
                onClick={() => onSelectTab('eat-well')}
                className="p-3.5 rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 hover:border-brand-500 cursor-pointer transition-all hover:shadow-sm group"
              >
                <div className="flex items-center gap-2 mb-1">
                  <Utensils className="w-4 h-4 text-brand-600" />
                  <span className="font-bold text-sm text-slate-900 dark:text-white">{t.eatWell}</span>
                </div>
                <div className="text-xs text-slate-500">{t.eatWellSub}</div>
              </div>
              ...
              >
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span className="font-bold text-sm text-slate-900 dark:text-white">{t.moveMore}</span>
                </div>
                <div className="text-xs text-slate-500">{t.moveMoreSub}</div>
              </div>
              ...
              >
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span className="font-bold text-sm text-slate-900 dark:text-white">{t.hintsHacks}</span>
                </div>
                <div className="text-xs text-slate-500">{t.hintsHacksSub}</div>
              </div>
            </div>
